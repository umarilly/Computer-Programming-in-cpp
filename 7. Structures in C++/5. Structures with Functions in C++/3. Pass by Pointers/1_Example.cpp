/*
    Program to demonstrate the use of structures with functions in C++ by passing a structure to a function by pointer.
*/
...
// Function to print and modify book details, passed by pointer
void printBookByPointer(Book *b) {
    // Print book details before modification
    cout << "Book Details Before Modification (Pass by Pointer) :- " << endl;
    cout << "The Title is : " << b->title << endl;
    cout << "The Author is : " << b->author << endl;
    cout << "The Year is : " << b->year << endl;

    // Modify the book details (this will affect the original structure)
...
int main() {
    ...
    // Call the function to print book details (pass by pointer)
    printBookByPointer(&b);
